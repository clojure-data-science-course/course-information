...
*** The minimum
You will at least need Java (version 8 or above) and Leiningen (version 2 or above).
...
For using Jupyter, we recommend [[https://github.com/clojupyter/lein-jupyter][lein-jupyter]].

(Another way to use them is [[http://beakerx.com/][BeakerX]]. We prefer not to use it here, because it seems to play less naturally together with other tools.)
...
Practical.li has a nice [[https://practicalli.github.io/clojure/development-tools/install-guides/][installation guides]] for several editors.
